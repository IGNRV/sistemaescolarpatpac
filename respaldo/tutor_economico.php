...
<div class="tutor-economico">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control to-uppercase" name="nombre" id="nombresTutor" value="<?php echo htmlspecialchars($nombreTutor); ?>">
        </div>
        <div class="form-group">
            <label for="apPaternoTutor">Apellido Paterno</label>
            <input type="text" class="form-control to-uppercase" name="apellido_paterno" id="apPaternoTutor" value="<?php echo htmlspecialchars($apPaternoTutor); ?>">
        </div>
        <div class="form-group">
            <label for="apMaternoTutor">Apellido Materno</label>
            <input type="text" class="form-control to-uppercase" name="apellido_materno" id="apMaternoTutor" value="<?php echo htmlspecialchars($apMaternoTutor); ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control to-uppercase" name="calle" id="calleTutor" value="<?php echo htmlspecialchars($calle); ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control to-uppercase" name="resto_direccion" id="restoDireccionTutor" value="<?php echo htmlspecialchars($restoDireccion); ?>">
        </div>
        <div class="form-group">
            <label for="villaPoblacionTutor">Villa/Población</label>
            <input type="text" class="form-control to-uppercase" name="villa_poblacion" id="villaPoblacionTutor" value="<?php echo htmlspecialchars($villaPoblacion); ?>">
        </div>
        <div class="form-group">
...
<table class="table">
    ...
    <form method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control to-uppercase" name="medioPago" id="medioPago" value="" maxlength="9">
        </div>
        <div class="form-group">
            <label for="bancoEmisor">Banco Emisor </label>
            <input type="text" class="form-control to-uppercase" name="bancoEmisor" id="bancoEmisor" value="">
        </div>
        <div class="form-group">
            <label for="tipoMedioPago">Tipo de Medio de Pago</label>
            <input type="text" class="form-control to-uppercase" name="tipoMedioPago" id="tipoMedioPago" value="">
        </div>     
