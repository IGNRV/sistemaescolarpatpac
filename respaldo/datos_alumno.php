...
if (isset($_POST['actualizar'])) {
    ...
    $stmtActualizar->bind_param("sssssssssssssssss", $nombre, $rutAlumno, $apPaterno, $apMaterno, $fechaNac, $rda, $calle, $nroCalle, $obsDireccion, $villa, $comunaSeleccionada, $idRegion, $idcomuna, $idcurso, $mail, $fono, $rutAlumnoHidden); // Usar $rutAlumnoHidden aquí
